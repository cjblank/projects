...
ImageFactory::~ImageFactory() {
  ...
  map<std::string, SDL_Surface*>::const_iterator si = surfaces.begin();
  map<std::string, SDL_Texture*>::const_iterator ti = textures.begin();
  map<std::string, Image*>::const_iterator fi = images.begin();
